...
namespace pacman::logic {
    ...
    enum class GhostKind : std::uint8_t { A = 0, B, C, D }; // Enum defining different ghost types
    ...
    public:
        ...
        virtual std::shared_ptr<Ghost> createGhost(GhostKind kind) = 0; // Builds a Ghost model
