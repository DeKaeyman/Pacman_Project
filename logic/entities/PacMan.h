...
public:
  ...
  Rect bounds() const override {
    return bounds_;
  } // Current bounding box of Pacman
  void update(double dt)
      override; // Continuous movement based on current direction and speed
  void
  setDirection(Direction dir) noexcept; // Set the current movement direction
