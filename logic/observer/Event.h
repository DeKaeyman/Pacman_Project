 ...
 */
enum class EventType : std::uint8_t { Tick, Moved, StateChanged, Collected, Died };
 ...
 */
using EventPayload = std::variant<std::monostate, MovedPayload, StateChangedPayload, CollectedPayload>;
