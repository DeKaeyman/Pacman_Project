...
public:
  ...
  std::pair<float, float> worldToPixel(float wx, float wy)
      const noexcept; // Convert a world space point to pixel coordinates

  PixelRect worldToPixel(const Rect &worldRect) const
      noexcept; // Convert a world space rectangle to a pixel space rectangle
