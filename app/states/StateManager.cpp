...
namespace pacman::app {
     ...
     */
    void StateManager::registerFactory(const Id& id, Factory factory) {
    ...
    void StateManager::push(const Id& id) {
        pending_.push_back(Action{ActionType::Push, id});
    }
    ...
    void StateManager::replace(const Id& id) {
        pending_.push_back(Action{ActionType::Replace, id});
    }
    ...
    void StateManager::pop() {
        pending_.push_back(Action{ActionType::Pop, {}});
    }
    ...
    void StateManager::clear() {
        pending_.push_back(Action{ActionType::Clear, {}});
    }
